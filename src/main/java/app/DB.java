...
public class DB implements IDatabase {
	...
	@Override
	public void insertIntoTable(String strTableName, Hashtable<String, Object> htblColNameValue) throws DBException {
	...
	@Override
	public void deleteFromTable(String strTableName, Hashtable<String, Object> htblColNameValue) throws DBException {
	...
	private void takeInsertAction(Table table, Hashtable<String, Object> htblColNameValue) throws DBException {

		// Validator.validateInsertionInput(table, htblColNameValue, myTables);
		// table.insertTuple(htblColNameValue);
	}

	private void takeDeleteAction(Table table, Hashtable<String, Object> htblColNameValue) throws DBException {

		// Validator.validateDeletionInput(table, htblColNameValue, myTables);
		// table.deleteTuples(htblColNameValue);
	}

	private void takeUpdateAction(Table table, Hashtable<String, Object> htblColNameValue) throws DBException {
	...
	// public Iterator selectFromTable(SQLTerm[] arrSQLTerms, String[] strarrOperators) throws DBException {
	...
	private void updateCsvFile(String strTableName, String indexName, String[] strarrColName) throws DBException {
		CsvWriter cw = new CsvWriter();
		cw.updateCsvFile(strTableName, indexName, strarrColName);
	}

	// private void insertExisitngTuples(OctreeIndex index, Table table) throws DBException {
	...
	public Iterator parseSQL(StringBuffer strbufSQL) throws DBException {
